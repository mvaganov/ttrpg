...
### Casting
**Casting Time** 1 minute
**Components** V, S, F (a crystal lens worth 200gp, 200gp diamond dust)
### Effect
**Range** touch
**Duration** instantaneous
### Description
Learn the motions and simple command words used by the last expert user of a magical or mechanical device, as if from a fragment of Legend Lore. Reduces skill DC to identify proper use of magic items by 10. 200gp diamond dust.
...
---
## Arudion, Greater
**School** Necromancy; **Level** bard 6, magus 6, sorcerer/wizard 6
### Casting
**Casting Time** 10 minutes
...
**Duration** see text (D)
### Description
As Tenacious Enigma, but can be used for any spell.
